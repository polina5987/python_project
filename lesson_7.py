...
while True:
    ...
    if len(input_letter) == 1 and input_letter.isalpha() and input_letter in secret_word.lower():
        for letter_index in range(len(secret_word)):
            if secret_word[letter_index].lower() == input_letter:
                encoded_word_letters[letter_index] = input_letter
